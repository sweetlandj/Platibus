...
<platibus baseUri="http://localhost:52180/platibus/">
  ...
  <endpoints>
    <add name="platibus" address="http://localhost:52180/platibus/" />
  </endpoints>
  <topics>
    <add name="Topic0" />
  </topics>
