...
namespace Platibus.Http
{
    ...
    public class HttpEvent : DiagnosticEvent
    {
        ...
        public HttpEvent(object source, DiagnosticEventType type, string detail = null, Exception exception = null, Message message = null, string endpoint = null, string queue = null, string topic = null, string remote = null, string method = null, Uri uri = null, int? status = null) 
