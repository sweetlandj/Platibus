...
namespace Platibus.Filesystem
{
    ...
    public class FilesystemEvent : DiagnosticEvent
    {
        ...
        public FilesystemEvent(object source, DiagnosticEventType type, string detail = null, Exception exception = null, Message message = null, EndpointName endpointName = null, QueueName queue = null, TopicName topic = null, FileInfo file = null, DirectoryInfo directory = null) 
